...
import { AstroKit } from '.';
import { WalletBase } from './wallet-base';

/**
 * Abstract base class for plugins
 * 
 * This class provides a foundation for building plugins that work with AstroKit
