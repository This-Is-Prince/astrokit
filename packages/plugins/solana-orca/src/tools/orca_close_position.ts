 ...
 *
 * ## Parameters
 * - `agent`: The `AstroKit` instance representing the wallet and connection details.
 ...
 *
 * @param agent - The `AstroKit` instance representing the wallet and connection.
