...
import { AstroKit, PriorityFeeResponse, SolanaWalletBase } from "astrokit";

/**
 * Sends a transaction with an estimated priority fee using the provided AstroKit.
 *
 * @param agent         An instance of AstroKit containing connection, wallet, etc.
