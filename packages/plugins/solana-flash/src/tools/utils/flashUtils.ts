 ...
 */
export function createPerpClient(agent: AstroKit<SolanaWalletBase>): PerpetualsClient {
...
export function get_flash_privilege(agent: AstroKit<SolanaWalletBase>): Privilege {
