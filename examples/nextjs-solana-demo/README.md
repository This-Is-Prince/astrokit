# AstroKit Solana Demo with Vercel AI

This is a Next.js project that demonstrates how to use the AstroKit SDK with the Vercel AI SDK to create an AI assistant capable of performing Solana blockchain operations.

## Features

- Interactive chat interface powered by Vercel AI SDK
- Integration with AstroKit for Solana blockchain operations
...
- Integrates AstroKit for Solana blockchain operations
...
- [AstroKit Documentation](https://github.com/yourusername/astrokit)
