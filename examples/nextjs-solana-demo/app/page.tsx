...
import { AstroKit, createSolanaTools, SolanaWalletBase } from 'astrokit';
import { useMemo, useState, FormEvent } from 'react';
import { solanaAdaptor } from '@astrokit/wallet-solana';
import AdrenaPlugin from '@astrokit/plugin-solana-adrena';
...
export default function Home() {
  ...
  const astroKitTools = useMemo(() => {
    ...
    astroKit.use(new AdrenaPlugin())

    return createSolanaTools(astroKit, astroKit.actions);
